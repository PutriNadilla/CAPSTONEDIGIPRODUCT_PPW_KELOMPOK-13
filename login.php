...
if (isset($_POST["simpan"])) {
    ...
    // Periksa apakah email dan password telah diisi
    if (empty($email) || empty($password)) {
        echo "<script>alert('Email dan password harus diisi.'); window.location ='index.php';</script>";
        exit;
    }
    ...
    if ($akunyangcocok == 1) {
        ...
        echo "<script>alert('Anda gagal login, Cek kembali Email dan Password Anda');</script>";
